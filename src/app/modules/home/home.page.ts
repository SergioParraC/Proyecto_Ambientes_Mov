...
import { EntregasComponent } from 'src/app/Components/entregas/entregas.component';
import { PaginaComponent } from 'src/app/Components/pagina/pagina.component';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, InfoUsuarioComponent ,EntregasComponent, PaginaComponent]
})
